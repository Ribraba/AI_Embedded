...
#define AI_AI4I_MODEL_SIGNATURE     "0x04cc7c199d1560923d938aa5a1571f79"
...
#define AI_TOOLS_DATE_TIME   "2025-03-22T18:54:27+0100"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_input_40_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Tensor #16 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_input_40_output, AI_STATIC,
  16, 0x0,
  AI_SHAPE_INIT(4, 1, 5, 1, 1), AI_STRIDE_INIT(4, 4, 4, 20, 20),
  1, &serving_default_input_40_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_input_40_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &gemm_0_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    768, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_AI4I_IN_NUM, &serving_default_input_40_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_AI4I_OUT_NUM, &nl_4_output),
  &gemm_0_layer, 0x1887a192, NULL)
